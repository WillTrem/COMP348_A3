...
printf("\nStatistics:\n")
puts "    Circle(s): #{shape_hash["Circle"]}"
puts "    Ellipse(s): #{shape_hash["Ellipse"]}"
puts "    Rhombus(es): #{shape_hash["Rhombus"]}"
puts "    --"
puts "    Shape(s): #{shape_hash["Shape"]}"